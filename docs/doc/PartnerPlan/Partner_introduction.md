...
| 4 | <a href="../../_static/image/PartnerPlan/adaptability_level_application.xlsx" >适配等级认证申请表(pdf) </a> | 填写样例 |
| 5 | 历史评测报告  | <a href="../../_static/image/PartnerPlan/report.pdf" target="_blank">基于大模型的AI芯片评测报告（0.2.1）（样例）</a> |
| 6 | 市场合作材料  | - |
| 7* | 产品介绍（word/ppt/pdf） | - |
