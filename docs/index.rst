...
1. :blue:`支持AI硬件接入，且已经实现6+以上国产芯片的训练支持` ；
2. :blue:`完善的一致性测例支持，支持5000+个算子测例，覆盖cv/nlp等常见模型`；
3. :blue:`覆盖20+以上cv模型，提供大模型支持，提供200+标准算子接口`；
4. :blue:`支持OpenMMLab等常见算法库`；
5. :blue:`支持Pytorch/SenseParrots等训练框架`；
